...
;; Use minibuffer candidates outside minibuffer
(defun db/down-from-outside ()
...
(defun db/to-and-from-minibuffer ()
...
(defun db/consult-find-file ()
  (interactive)
  (consult-find default-directory))

;; (add-to-list 'consult-preview-excluded-hooks 'python-mode)
